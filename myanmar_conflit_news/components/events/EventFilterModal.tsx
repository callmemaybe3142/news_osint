...
export function EventFilterModal({ options, isOpen, onClose }: EventFilterModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white dark:bg-gray-900">
            ...
            {/* Footer */}
            <div className="fixed bottom-0 left-0 right-0 flex gap-2 border-t border-gray-200 bg-white p-4 dark:border-gray-700 dark:bg-gray-800">
                <button
                    onClick={resetFilters}
                    className="flex-1 rounded-lg border border-gray-300 px-4 py-3 text-sm font-semibold text-gray-700 transition-colors hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-700"
                >
                    Reset
                </button>
                <button
